...
6. **매수·매도 시그널** (`kis_signal.py`) — RSI 선을 넘으면 12봉 무장, MACD 히스토그램 부호가 바뀌면. 강/약, 추세 순응/역추세.
...
- **규칙을 고치면 `python -m unittest discover tests` 부터** (39개, 네트워크·실제 파일 안 씀). 새 규칙은 `tests/test_rules.py` 에 시험도 더한다.
